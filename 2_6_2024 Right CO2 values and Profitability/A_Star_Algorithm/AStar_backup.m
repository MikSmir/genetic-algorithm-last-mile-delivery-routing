function [Optimal_path, path_cost] = AStar_backup(Startx, Starty, Targetx, Targety, targetnum, blockLength, blockWidth, streetWidth)
...
if ( (xval == xTarget) && (yval == yTarget))
 ...
 j=j-200; %increased speed of plotting, it was 1
 for i=j:-1:1
  %pause(.25);
