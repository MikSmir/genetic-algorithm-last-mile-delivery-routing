...
function [Optimal_path, path_cost] = AStar(Startx, Starty, Targetx, Targety, targetnum)
...
MAP(50+1:150-1, 50+1) = -1;
MAP(200+1:300-1, 50+1) = -1;
MAP(350+1:450-1, 50+1) = -1;
MAP(50+1:150-1, 150-1) = -1;
MAP(200+1:300-1, 150-1) = -1;
MAP(350+1:450-1, 150-1) = -1;

MAP(50+1:150-1, 200+1) = -1;
MAP(200+1:300-1, 200+1) = -1;
MAP(350+1:450-1, 200+1) = -1;
MAP(50+1:150-1, 300-1) = -1;
MAP(200+1:300-1, 300-1) = -1;
MAP(350+1:450-1, 300-1) = -1;

MAP(50+1:150-1, 350+1) = -1;
MAP(200+1:300-1, 350+1) = -1;
MAP(350+1:450-1, 350+1) = -1;
MAP(50+1:150-1, 450-1) = -1;
MAP(200+1:300-1, 450-1) = -1;
MAP(350+1:450-1, 450-1) = -1;


MAP(50+1, 50+1:150-1) = -1;
MAP(50+1, 200+1:300-1) = -1;
MAP(50+1, 350+1:450-1) = -1;
MAP(150-1, 50+1:150-1) = -1;
MAP(150-1, 200+1:300-1) = -1;
MAP(150-1, 350+1:450-1) = -1;

MAP(200+1, 50+1:150-1) = -1;
MAP(200+1, 200+1:300-1) = -1;
MAP(200+1, 350+1:450-1) = -1;
MAP(300-1, 50+1:150-1) = -1;
MAP(300-1, 200+1:300-1) = -1;
MAP(300-1, 350+1:450-1) = -1;

MAP(350+1, 50+1:150-1) = -1;
MAP(350+1, 200+1:300-1) = -1;
MAP(350+1, 350+1:450-1) = -1;
MAP(450-1, 50+1:150-1) = -1;
MAP(450-1, 200+1:300-1) = -1;
MAP(450-1, 350+1:450-1) = -1;



MAP(floor(Startx), floor(Starty)) = 0; % Start
MAP(floor(Targetx), floor(Targety)) = 1; % Target
